...
public:
    static auto init(SDL_Event* evento_) -> void
    {
        ...
        //Tercer caracter: S: requiere pulsar shift. C: requiere pulsar ctrl. A: requiere pulsar alt. -: sin modificador
        ...
        acciones.insert(std::make_pair("s1C", ACCION::CrearInterruptor));
        acciones.insert(std::make_pair("s2C", ACCION::CrearBoton));
        acciones.insert(std::make_pair("s3C", ACCION::CrearSalida));
        acciones.insert(std::make_pair("s4-", ACCION::CrearTemporizador));
        acciones.insert(std::make_pair("s5-", ACCION::CrearCondensador));
    ...
    [[nodiscard]] static auto getShift() -> bool { return shift; }
    [[nodiscard]] static auto getCtrl() -> bool { return ctrl; }
    [[nodiscard]] static auto getAlt() -> bool { return alt; }
};
